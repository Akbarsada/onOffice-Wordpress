...
function create_immo_Land_taxonomy() {
    ...
    register_taxonomy( 'land', [ 'projects_en' ], $args );
...
function create_immo_Stadt_taxonomy() {
    ...
    register_taxonomy( 'stadt', [ 'projects_en' ], $args );
...
function create_immo_district_taxonomy() {
    ...
    register_taxonomy( 'district', [ 'projects_en' ], $args );
...
function create_immo_miete_taxonomy() {
    ...
    register_taxonomy( 'miete', [ 'projects_en' ], $args );
...
function create_immo_flaeche_taxonomy() {
    ...
    register_taxonomy( 'flaeche', [ 'projects_en' ], $args );
...
function create_immo_anzahl_zimmer_taxonomy() {
    ...
    register_taxonomy( 'anzahl_zimmer', [ 'projects_en' ], $args );
...
function create_immo_loggia_taxonomy() {
    ...
    register_taxonomy( 'loggia', [ 'projects_en' ], $args );
...
function create_immo_balkon_taxonomy() {
    ...
    register_taxonomy( 'balkon', [ 'projects_en' ], $args );
...
function create_immo_terrasse_taxonomy() {
    ...
    register_taxonomy( 'terrasse', [ 'projects_en' ], $args );
...
function create_immo_garten_taxonomy() {
    ...
    register_taxonomy( 'garten', [ 'projects_en' ], $args );
...
function create_immo_aufzug_taxonomy() {
    ...
    register_taxonomy( 'aufzug', [ 'projects_en' ], $args );
...
function create_immo_barrierefrei_taxonomy() {
    ...
    register_taxonomy( 'barrierefrei', [ 'projects_en' ], $args );
...
function create_immo_keller_taxonomy() {
    ...
    register_taxonomy( 'keller', [ 'projects_en' ], $args );
...
function create_immo_moebeliert_taxonomy() {
    ...
    register_taxonomy( 'moebeliert', [ 'projects_en' ], $args );
...
function create_immo_parkplatz_taxonomy() {
    ...
    register_taxonomy( 'parkplatz', [ 'projects_en' ], $args );
...
function create_immo_seniorengerecht_taxonomy() {
    ...
    register_taxonomy( 'seniorengerecht', [ 'projects_en' ], $args );
...
function create_immo_erstbezug_taxonomy() {
    ...
    register_taxonomy( 'erstbezug', [ 'projects_en' ], $args );
...
function create_immo_neuwertig_taxonomy() {
    ...
    register_taxonomy( 'neuwertig', [ 'projects_en' ], $args );
...
function create_estate_saniert_taxonomy() {
    ...
    register_taxonomy( 'saniert', [ 'projects_en' ], $args );
