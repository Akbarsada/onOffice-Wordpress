...
function create_projects_Land_taxonomy() {
    ...
    register_taxonomy( 'land', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_Land_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy City
function create_projects_Stadt_taxonomy() {
    ...
    register_taxonomy( 'stadt', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_Stadt_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy District
function create_projects_district_taxonomy() {
    ...
    register_taxonomy( 'district', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_district_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Miete
function create_projects_miete_taxonomy() {
    ...
    register_taxonomy( 'miete', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_miete_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Fläche
function create_projects_flaeche_taxonomy() {
    ...
    register_taxonomy( 'flaeche', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_flaeche_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy anzahl Zimmer
function create_projects_anzahl_zimmer_taxonomy() {
    ...
    register_taxonomy( 'anzahl_zimmer', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_anzahl_zimmer_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Loggia
function create_projects_loggia_taxonomy() {
    ...
    register_taxonomy( 'loggia', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_loggia_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Balkon
function create_projects_balkon_taxonomy() {
    ...
    register_taxonomy( 'balkon', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_balkon_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Terrasse
function create_projects_terrasse_taxonomy() {
    ...
    register_taxonomy( 'terrasse', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_terrasse_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Garten
function create_projects_garten_taxonomy() {
    ...
    register_taxonomy( 'garten', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_garten_taxonomy' );



////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Aufzug
function create_projects_aufzug_taxonomy() {
    ...
    register_taxonomy( 'aufzug', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_aufzug_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Barrierefrei
function create_projects_barrierefrei_taxonomy() {
    ...
    register_taxonomy( 'barrierefrei', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_barrierefrei_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Keller
function create_projects_keller_taxonomy() {
    ...
    register_taxonomy( 'keller', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_keller_taxonomy' );

////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Möbeliert
function create_projects_moebeliert_taxonomy() {
    ...
    register_taxonomy( 'moebeliert', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_moebeliert_taxonomy' );

////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Parkplatz
function create_projects_parkplatz_taxonomy() {
    ...
    register_taxonomy( 'parkplatz', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_parkplatz_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Seniorengerecht
function create_projects_seniorengerecht_taxonomy() {
    ...
    register_taxonomy( 'seniorengerecht', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_seniorengerecht_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Erstbezug
function create_projects_erstbezug_taxonomy() {
    ...
    register_taxonomy( 'erstbezug', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_erstbezug_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Neuwertig
function create_projects_neuwertig_taxonomy() {
    ...
    register_taxonomy( 'neuwertig', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_neuwertig_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Saniert
function create_projects_saniert_taxonomy() {
    ...
    register_taxonomy( 'saniert', [ 'projects' ], $args );

}
add_action( 'init',  'create_projects_saniert_taxonomy' );
