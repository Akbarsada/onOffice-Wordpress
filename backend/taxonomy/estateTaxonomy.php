...
function create_estate_Land_taxonomy() {
...
add_action( 'init',  'create_estate_Land_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy City
function create_estate_Stadt_taxonomy() {
...
add_action( 'init',  'create_estate_Stadt_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy District
function create_estate_district_taxonomy() {
...
add_action( 'init',  'create_estate_district_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Miete
function create_estate_miete_taxonomy() {
...
add_action( 'init',  'create_estate_miete_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Fläche
function create_estate_flaeche_taxonomy() {
...
add_action( 'init',  'create_estate_flaeche_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy anzahl Zimmer
function create_estate_anzahl_zimmer_taxonomy() {
...
add_action( 'init',  'create_estate_anzahl_zimmer_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Loggia
function create_estate_loggia_taxonomy() {
...
add_action( 'init',  'create_estate_loggia_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Balkon
function create_estate_balkon_taxonomy() {
...
add_action( 'init',  'create_estate_balkon_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Terrasse
function create_estate_terrasse_taxonomy() {
...
add_action( 'init',  'create_estate_terrasse_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Garten
function create_estate_garten_taxonomy() {
...
add_action( 'init',  'create_estate_garten_taxonomy' );



////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Aufzug
function create_estate_aufzug_taxonomy() {
...
add_action( 'init',  'create_estate_aufzug_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Barrierefrei
function create_estate_barrierefrei_taxonomy() {
...
add_action( 'init',  'create_estate_barrierefrei_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Keller
function create_estate_keller_taxonomy() {
...
add_action( 'init',  'create_estate_keller_taxonomy' );

////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Möbeliert
function create_estate_moebeliert_taxonomy() {
...
add_action( 'init',  'create_estate_moebeliert_taxonomy' );

////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Parkplatz
function create_estate_parkplatz_taxonomy() {
...
add_action( 'init',  'create_estate_parkplatz_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Seniorengerecht
function create_estate_seniorengerecht_taxonomy() {
...
add_action( 'init',  'create_estate_seniorengerecht_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Erstbezug
function create_estate_erstbezug_taxonomy() {
...
add_action( 'init',  'create_estate_erstbezug_taxonomy' );


////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register Taxonomy Neuwertig
function create_estate_neuwertig_taxonomy() {
...
add_action( 'init',  'create_estate_neuwertig_taxonomy' );
