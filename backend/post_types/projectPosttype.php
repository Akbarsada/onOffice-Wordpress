...
function create_project_PostType() {
    ...
    $labels = [
        'name'                  => _x( 'Projekte', 'Post Type General Name', 'eugen' ),
        'singular_name'         => _x( 'Projekte', 'Post Type Singular Name', 'eugen' ),
        'menu_name'             => _x( 'Projekte', 'Admin Menu text', 'eugen' ),
        'name_admin_bar'        => _x( 'Projekte', 'Add New on Toolbar', 'eugen' ),
...
add_action( 'init', 'create_project_PostType' , 0 );